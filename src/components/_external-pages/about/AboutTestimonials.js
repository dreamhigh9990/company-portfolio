...
const TESTIMONIALS = [
  {
    name: 'Jenny Wilson',
    rating: 5,
    dateCreate: 'September 10, 2021',
    content: `Excellent Work! Thanks a lot!`
  },
  {
    name: 'Cody Fisher',
    rating: 5,
    dateCreate: 'October 2, 2021',
    content: `Get to work on a product and in a space that is completely new and revolutionary. The people and the leaders at this company especially are extremely passionate and care about the product and the team members. Everyone is very collaborative and thoughtful.`
  },
  {
    name: 'Marvin McKinney',
    rating: 5,
    dateCreate: 'April 15, 2021',
    content: `Customer support is realy fast and helpful the desgin of website they built is looks amazing also the code is very clean and readble realy good job !`
  },
  {
    name: 'Darrell Steward',
    rating: 5,
    dateCreate: 'May 7, 2021',
    content: `Amazing, really good code quality and gives you a lot of examples for implementations.`
  },
  {
    name: 'Jacob Jones',
    rating: 5,
    dateCreate: 'August 10, 2021',
    content: `Got a few questions after purchasing the product. The owner responded very fast and very helpfull. Overall the code is excellent and works very good. 5/5 stars!`
  },
  {
    name: 'Bessie Cooper',
    rating: 5,
    dateCreate: 'November 7, 2021',
    content: `TWebile has been an amazing company to work with so far, they are cutting edge and have lots of interesting projects to get involved with. The team care about the staff and often go out of their way to ensure happiness. The leadership team has a strong vision and is also willing to take influence from any level - I would recommend  twebile.com to work with!`
  }
];
