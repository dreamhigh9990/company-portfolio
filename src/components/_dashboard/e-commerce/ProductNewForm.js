...
const CATEGORY_OPTION = [
  { group: 'Gucci', classify: ['Shirts', 'T-shirts', 'Jeans', 'Leather'] },
  { group: 'Rolex', classify: ['Watches for Women', 'Watches for Men'] },
  { group: 'Chanel', classify: ['Shoes', 'Backpacks and bags', 'Bracelets', 'Face masks'] }
];
          ...
          <Grid item xs={12} md={4}>
            <Stack spacing={3}>
              <Card sx={{ p: 3 }}>
                ...
                <Stack spacing={3}>
                  <TextField fullWidth label="Serial Number" {...getFieldProps('code')} />
                  <TextField fullWidth label="Product Amount" {...getFieldProps('sku')} />
